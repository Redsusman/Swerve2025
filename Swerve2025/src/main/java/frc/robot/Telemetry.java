...
public class Telemetry {
        ...
        public void telemeterize(SwerveDriveState state) {
                ...
                // .transformBy(new Transform2d(targetPose.getTranslation(),
                // targetPose.getRotation()));
                // Pose2d goalTransformedPoseTwo = targetPose
                // .transformBy(new Transform2d(currentPose.getTranslation(),
                // currentPose.getRotation()));
                // Pose2d goalPose = new Pose2d(0,2,Rotation2d.fromDegrees(0));
                Pose2d transformedPose = currentPose.relativeTo(targetPose);
                ...
                poseReferences.set(new Pose2d[] { targetPose, transformedPose, backupPose});
